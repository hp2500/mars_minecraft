...
ggplot(data = df_plot, 
  ...
  #annotate("text", x = 0, y = 4, label = "SC = 1.22", size = 5) +
  #annotate("text", x = 7, y = 4, label = "SC = 1.22", size = 5) +
  #annotate("text", x = -5, y = 0, label = "SC = 1.22", size = 5) +
  #annotate("text", x = 5, y = -2, label = "SC = 1.22", size = 5)
...
sc_feat_all_clust %>% group_by(cluster) %>% summarise(mean(sc))
